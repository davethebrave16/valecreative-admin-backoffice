...
Storage path convention: `{resourceType}/{uuid}/{filename}` (e.g., `series/abc-123/photo.jpg`). Resized variants (`thumbs/`, `medium/`) are auto-generated by the Firebase Resize Images extension at the same folder level.
